...
- base neutra clara para lectura prolongada;
- superficies blancas y bordes discretos;
...
- Foco: contorno azul de 3 px, independiente del color de marca.
...
- `.start-options`: elección explícita entre sugerido, otro día y libre.
...
- sesión activa, catálogo y formulario accesibles sin ampliar la pantalla;
...
El rediseño apoya entrenamiento y rutinas y conserva Diario/Nutrición como áreas
del prototipo. No se ha diseñado todavía la modificación de ejercicios durante
una sesión ni el flujo nutricional por etiqueta.
